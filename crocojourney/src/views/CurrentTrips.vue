                ...
                <div class="col-md-8" style="width: auto; margin-left: 1%; margin-right: 1%;">
                    <div class="scrollable">
                        <div v-if="trips.length === 0" class="card">
                            <h5 class="card-title" style="margin: auto;">Vous n'avez pas encore de trajets en cours</h5>
                        </div>
                        <a v-else>
                                                ...
                                                <div class="container-fluid">
                                                    <div class="row">
                                                                ...
                                                                <div style="display: flex; flex-wrap: wrap;">
                                                                    ...
                                                                    <div style="width: 35%; margin-top: 1%;">
                                                                        <div>
                                                                            <p class="card-text" style="font-size: large;">
                                                                                <span class="fw-bold me-2">•</span>
                                                                                Départ: {{new Date(trip.date).toLocaleDateString('fr-FR')}} à {{new Date(time).getHours() + ':' + new Date(time).getMinutes().toString().padStart(2, '0')}}
                                                                            </p>
                                                                        </div>
                                                                        <div>
                                                                            <p class="card-text" style="font-size: large;">
                                                        ...
                                                        <div class="col d-flex justify-content-center align-items-center">
                                                            <RouterLink :to="{ name: 'DetailTrip', params: { id: trip.id }}" class="btn btn-success align-middle">Voir</RouterLink>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
